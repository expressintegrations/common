...
class StorageService(BaseService):
    ...
    def upload_file_from_memory(self, bucket_name: str, destination_file_name: str, contents) -> None:
        bucket = self.storage_client.bucket(bucket_name=bucket_name)
        blob = bucket.blob(destination_file_name)
        blob.upload_from_string(contents)

    def download_file(self, bucket_name: str, source_file_name: str, destination_file_name: str):
